...
See all courses offered in current and former semesters in the online course catalogue [QIS](https://qis.server.uni-frankfurt.de/qisserver/rds?state=wtree&search=1&category=veranstaltung.browse&navigationPosition=lectures%2Clectureindex&breadcrumb=lectureindex&topitem=lectures&subitem=lectureindex&noDBAction=y&init=y).
...
- stylised facts in the risk-return profile and key characteristics of international financial portfolios;
- the structure of the asset management industry and stylised facts on cross border portfolio flows;
- the global financial cycle (in particular the shifts between ”risk on” and ”risk off” episodes) as driver of portfolio flows and asset returns in different countries, and the role of internationally active financial intermediaries (e.g. global banks);
- the role of country fundamentals and policies in driving portfolio flows; and
- policy implications of volatile portfolio flows for advanced and emerging markets.
